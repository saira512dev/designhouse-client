                        ...
                        <div class="col-md-8">
                            ...
                            <div class="design-comments mt-3">
                                <h1 class="font-16 fw-300 mb-4">
                                    <strong class="fw-500" v-if="comments"
                            ...
                            <template v-if="$auth.loggedIn">
                                <form @submit.prevent="save">
                                    <base-textarea :rows="2" :form="form" field="body"
                                        v-model="form.body" placeholder="Enter a comment">
                                    </base-textarea>
                            ...
                            <div class="post-detail-sidebar">
                                ...
                                <div class="designs-tag-outer mt-3">
                                    ...
                                    <div class="designs-tag font-14 fw-300" v-if="design.tag_list">
                                        <a v-for="(tag,i) in design.tag_list.tags"
                                            :key="`tag-${i}`"
